...
class Config:
    ...
    COURSES_REGISTRY = Path(os.environ.get("COURSES_REGISTRY", str(DATA_DIR / "courses.yaml")))
    COURSES_ROOT = Path(os.environ.get("COURSES_ROOT", str(DATA_DIR / "courses")))
    ...
    COURSE_CONFIG = Path(os.environ.get("COURSE_CONFIG", str(DATA_DIR / "course.yaml")))
    TEACHER_USERNAME = os.environ.get("TEACHER_USERNAME", "teacher")
    TEACHER_PASSWORD = os.environ.get("TEACHER_PASSWORD", "")
    MAX_UPLOAD_MB = int(os.environ.get("MAX_UPLOAD_MB", "20"))
    MAX_TEMPLATE_MB = int(os.environ.get("MAX_TEMPLATE_MB", "50"))
